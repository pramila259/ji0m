...
// Error class for object not found
...
export class ObjectStorageService {
  ...
  // Generate upload URL for object entity
  ...
  // Normalize object entity path from raw upload URL
  ...
  // Parse object path to get bucket name and object name
